...
system_options = '''Ты - туристический консультант, твоя задача - подобрать для клиента места, экскурсии и маршруты, которые бы его заинтересовали.'''

human_options = '''На основе нашего диалога, придумай для меня варианты ответа на твой вопрос. Напиши варианты в виде JSON list'''